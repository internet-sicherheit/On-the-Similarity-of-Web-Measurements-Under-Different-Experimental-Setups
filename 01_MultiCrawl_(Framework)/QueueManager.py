...
def restart():
    ...
    try:
        ...
        # , shell=True)
        subprocess.call(
            '/home/ifis/Desktop/repo/framework/multicrawl/restart.sh')
    except:
        os.execl('/home/ifis/miniconda3/envs/openwpm/bin/python3',
...
def startNewCrawler(id):
    ...
    subprocess.Popen(['/home/ifis/miniconda3/envs/openwpm/bin/python3',
