...
def stream2BQ(p_siteData):
    try:
            ...
            if cookies is not None:
                for item in cookies:
                    ...
                    try:
                        ...
                        execBQRows('your-bigquery-data-set.diff.cookies', item, 25)
            ...
            if localStorage is not None:
                for item in localStorage:
                    ...
                    try:
                        ...
                        execBQRows(
                            'your-bigquery-data-set.diff.localstorage', item, 25)
                    except Exception as e:
                        pushError(siteData.site_id,
        ...
        try:
            execBQRows('your-bigquery-data-set.diff.requests', all_requests, 45)
            all_pushed_req = True
        except:
            all_pushed_req = False
            ...
            for visit in siteData.visitData:
                ...
                if requests is not None:
                    for item in requests:
                        ...
                        try:
                            execBQRows(
                                'your-bigquery-data-set.diff.requests', item, 15)
                        except:
        ...
        try:
            execBQRows('your-bigquery-data-set.diff.responses', all_response, 45)
            all_pushed_res = True
        except:
            all_pushed_res = False
            ...
            for visit in siteData.visitData:
                ...
                if responses is not None:
                    for item in responses:
                        ...
                        try:
                            execBQRows(
                                'your-bigquery-data-set.diff.responses', item, 15)
                        except:
        ...
        if all_callstacks:
            ...
            try:
                execBQRows('your-bigquery-data-set.diff.callstacks', all_callstacks, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if callstacks is not None:
                        for item in callstacks:
                            ...
                            try:
                                execBQRows(
                                    'your-bigquery-data-set.diff.callstacks', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_dns_responses:
            ...
            try:
                execBQRows('your-bigquery-data-set.diff.dns_responses', all_dns_responses, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if dns_responses is not None:
                        for item in dns_responses:
                            ...
                            try:
                                execBQRows(
                                    'your-bigquery-data-set.diff.dns_responses', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_incomplete_visit: 
            ...
            try:
                execBQRows('your-bigquery-data-set.diff.incomplete_visits', all_incomplete_visit, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if incomplete_visit is not None:
                        for item in incomplete_visit:
                            ...
                            try:
                                execBQRows(
                                    'your-bigquery-data-set.diff.incomplete_visits', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_http_redirects:
            ...
            try:
                execBQRows('your-bigquery-data-set.diff.http_redirects', all_http_redirects, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if http_redirects is not None:
                        for item in http_redirects:
                            ...
                            try:
                                execBQRows(
                                    'your-bigquery-data-set.diff.http_redirects', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_navigations:
            ...
            try:
                execBQRows('your-bigquery-data-set.diff.navigations', all_navigations, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if navigations is not None:
                        for item in navigations:
                            ...
                            try:
                                execBQRows(
                                    'your-bigquery-data-set.diff.navigations', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        for visit in siteData.visitData:  
            ...
            if requests is not None:  
                for item in requests:
                    ...
                    push_request = push_request + len(item)
                    try:
                        execBQRows('your-bigquery-data-set.diff.requests', item) 
                    except:
            ...
            if responses is not None:
                ...
                for item in responses:
                    ...
                    try:
                        execBQRows('your-bigquery-data-set.diff.responses', item) 
                    except:
                        print(item)
    ...
    if siteData.crawlData != None:
        ...
        for item in allReq:
            print('pushing chunked req: ', str(len(item)))
            try:
                execBQRows('your-bigquery-data-set.diff.http_request',
                           item)
                push_request=1
            except:
        ...
        for item in allRes:
            print('pushing chunked res: ', str(len(item)))
            try:
                execBQRows('your-bigquery-data-set.diff.http_response',
                       item)
                push_response=1
            except:
                print(item)
        ...
        if siteData.cookies:
            try:
                ...
                execBQRows('your-bigquery-data-set.diff.cookies', siteData.cookies)
                push_cookie=1
            except Exception as e:
        ...
        if siteData.localStorage:
            try:
                ...
                execBQRows('your-bigquery-data-set.diff.localstorage',
